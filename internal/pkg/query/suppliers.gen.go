...
func newSupplier(db *gorm.DB, opts ...gen.DOOption) supplier {
	...
	_supplier.ID = field.NewString(tableName, "id")
	_supplier.SupplierName = field.NewString(tableName, "supplier_name")
	_supplier.ContactPerson = field.NewString(tableName, "contact_person")
	_supplier.Email = field.NewString(tableName, "email")
	_supplier.Phone = field.NewString(tableName, "phone")
...
func (s *supplier) updateTableName(table string) *supplier {
	...
	s.ContactPerson = field.NewString(table, "contact_person")
...
func (s *supplier) fillFieldMap() {
	...
	s.fieldMap["contact_person"] = s.ContactPerson
